...
{
    private final static int[] CandidateMoveVectorCoordinate={ -8,-1,1,8 };
    ...
    {
        return BoardUtils.FirstColoumn[currentPosition] && (candidateOfset==-1);
    }
    private static boolean isTenthColoumnExclusion(final int currentPosition,final int candidateOfset)
    {
        return BoardUtils.EighthColoumn[currentPosition] && (candidateOfset==1);
    }
}
